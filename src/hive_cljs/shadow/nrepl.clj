...
(defrecord ShadowNrepl [conn-atom opts]
  ...
  ;; The dialect this channel's runtime speaks. A ClojureScript runtime reached
  ;; over shadow's nREPL is a re-frame application, so the vocabulary and the
  ;; introspection both resolve there.
